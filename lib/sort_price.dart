...
String sortPrice(num number) {
  ...
  switch (intNumber.length) {
    ...
    case 2: fullNumber = subString(intNumber, 0, 1) + subString(intNumber, 1); break;
    case 3: fullNumber = subString(intNumber, 0, 2) + subString(intNumber, 2); break;
...
String subString(String number, [int start, int end]) => number.substring(start, end);